...
# The fitness function will return a count of the adjacent numbers that are in ascending order with 1 freebie because the
# initial position doesn’t have a gene to its left.
